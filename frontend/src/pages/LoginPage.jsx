...
const LoginPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const user = await login(credentials); // login giờ trả về user
            toast.success(`Chào mừng trở lại, ${user.fullName || user.username}!`, { id: toastId });
            ...
            toast.error(err.message || "Đăng nhập thất bại, vui lòng thử lại.", { id: toastId });
        }
    };
