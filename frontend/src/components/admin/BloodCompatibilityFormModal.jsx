...
const BloodCompatibilityFormModal = ({ isOpen, onClose, onSaveSuccess, rule }) => {
    ...
    const fetchDropdownData = useCallback(async () => {
        ...
        try {
            const typesData = await bloodService.getBloodTypes();
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (rule?.id) {
                await bloodService.updateBloodCompatibility(rule.id, dataToSend);
            } else {
                await bloodService.createBloodCompatibility(dataToSend);
            }
